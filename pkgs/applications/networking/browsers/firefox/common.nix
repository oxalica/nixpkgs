...
buildStdenv.mkDerivation ({
 ...
 '';
  ...
  setOutputFlags = false; # `./mach configure` doen's understand `--*dir=` flags.
  ...
  # FIXME: The separateDebugInfo hook skips artifacts whose Build ID's length is not 40.
  # But we got 16-length Build ID here. Override it to make it work.
